...
public class BranchEdgePool
		extends AbstractListenableEdgePool< BranchEdge, BranchVertex, ByteMappedElement >
{
	...
	private static class BranchEdgeFactory
			implements PoolObject.Factory< BranchEdge, ByteMappedElement >
	{
