...
public abstract class AbstractTrackSchemeOverlay implements OverlayRenderer, OffsetHeadersListener
{
	 ...
	 */
	protected abstract boolean isInsidePaintedVertex( final double x, double y, final ScreenVertex vertex );
	 ...
	 */
	protected abstract double distanceToPaintedEdge( final double x, double y, final ScreenEdge edge, ScreenVertex source, ScreenVertex target );
